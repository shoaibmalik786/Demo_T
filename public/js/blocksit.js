(function($) {
	...
	$.fn.BlocksIt = function(options) {
		...
		content = $(this);
		colwidth = content.width() / blocksOptions.numOfCol;

		//create empty blockarr
		createEmptyBlockarr();

		content.children(blocksOptions.blockElement).each(function(e) {
			setPosition($(this), e);
		});
		
		//set final height of content
		var heightarr = getHeightArr(0, blockarr.length);
		content.height(heightarr[1] + blocksOptions.offsetY);
